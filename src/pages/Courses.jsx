...
import PostImage1 from "../images/audi.jpg";
        ...
        <div className="bg-gray-100 absolute h-full w-full overflow-auto">
          <div className=" ml-60 flex flex-row space-x-8 mt-10 ">
            ...
            <p className="flex flex-col ">
              ...
              <h1 className=" w-72 max-h-8 overflow-hidden mt-4 font-bold text-3xl">
                The Best Of Audi{" "}
              </h1>
              <p className="w-103 max-h-36 overflow-hidden mt-3 text-sm">
                ...
                error,molestiae quas vel sint commodi repudiandae consequuntur
