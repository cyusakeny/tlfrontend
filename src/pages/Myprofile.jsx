            ...
            <div className="">
                ...
                <div className="w-36 mt-10 h-32 ml-48">
                        ...
                        <label className=" flex flex-col border border-gray-color bg-gray-color items-center hover:text-white hover:bg-blue-color  w-36 px-2">
                            ...
                            <input type="file" name="ProfileImage" id="ImageId" className="hidden" onChange={this.handlePictureUpload} />
                        </label>
                        </div>
                        ...
                        <div className="w-full  ml-96.50 mt-2 font-sans max-w-xl">
                            <p className="text-xl text-blue-color-50">"Training to become the lord"</p>
                        </div>
                        ...
                        <div className="flex flex-row w-9/12 space-x-40 ml-96.50 mt-6 font-sans max-w-xl border-b-2 border-gray-400">
                            <Link className="text-xl text-black  pl-4 -mb-0.5 border-blue-color-150 w-24" style={{color:this.state.color1,borderBottom:this.state.border1}} onClick={this.changeToAbout}>About</Link>
                            <Link className="text-xl text-blue-color-100" style={{color:this.state.color2,borderBottom:this.state.border2}} onClick={this.changeToProgress}>Progress</Link>
                        </div>
                        <div className="flex flex-row w-9/12 ml-96.50 mt-2 font-sans max-w-xl ">
                             <p className="text-xl w-24">{this.state.row1}</p>
                             <p className=" ml-40 text-xl w-52 text-blue-color-200">{this.state.data1}</p>
                        </div>
                        <div className="flex flex-row w-9/12 ml-96.50 mt-2 font-sans max-w-xl ">
                             <p className="text-xl w-24">{this.state.row2}</p>
                             <p className=" ml-40 text-xl w-24 text-blue-color-200">{this.state.data2}</p>
                        </div>
                        <div className="flex flex-row w-9/12 ml-96.50 mt-2 font-sans max-w-xl ">
                             <p className="text-xl w-24">{this.state.row3}</p>
                             <p className=" ml-40 text-xl w-80 text-blue-color-200">{this.state.data3}</p>
                        </div>
                        <div className="flex flex-row w-9/12 ml-96.50 mt-2 font-sans max-w-xl ">
                             <p className="text-xl w-24">{this.state.row4}</p>
                             <p className=" ml-40 text-xl w-52 text-blue-color-200">{this.state.data4}</p>
                        </div>
                        <div className="flex flex-row w-9/12 ml-96.50 mt-2 font-sans max-w-xl ">
                             <p className="text-xl w-24">{this.state.row5}</p>
                             <p className=" ml-40 text-xl w-52 text-blue-color-200 h-0">{this.state.data5}</p>
                        </div>
                        <div className="w-24 bg-blue-color-250 relative ml-96.50 mt-10 pl-10 rounded-md ">
                          <Link to="" className="text-xl text-white"><EditSvg className="fill-current text-white w-5 h-5 absolute left-4 top-1 bottom-1"/>Edit</Link>
                        </div>
                </div>
            </div>
         );
