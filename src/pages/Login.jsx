...
class Login extends Component {
    render() { 
       ...
       <div className="bg-white  ml-80 absolute h-full w-9.10 border-2 overflow-hidden">
        ...
        <p className="text-gray-color-50 font-prompt">Don't Have An Account?</p>
        <Link to="/createaccount" className="font-bold font-prompt">Create Account</Link>
        </div>
        <div className="flex flex-row mt-10 ml-16 space-x-4">
        <p className="text-3xl">Log into</p>
        <p className="text-3xl">TYPING</p>
        <p className="text-2xl font-postcolombo mt-0.5 text-yellow-color">LORD</p>
        </div>
        <form action="" className="flex flex-col mt-6 ml-12">
           <label className=" text-xl text-gray-color-100">EMAIL</label>
           <input type="email" name="Email" id="EmailId" placeholder="EMAIL" className="border border-black 
           ml-10 pl-4 h-7 w-72 rounded-r-sm  outline-none" required/>
           <MailIcon className="w-10 h-7 border border-black -mt-7"/>
           <label className=" text-xl text-gray-color-100 mt-6">PASSWORD</label>
           <input type="password" name="Password" id="PasswordId" placeholder="PASSWORD" className="border border-black ml-10 pl-4 h-7 w-72 rounded-r-sm 
            outline-none" required />
           <PassIcon className="w-10 h-7 border border-black -mt-7"/>
         <Link to="" className="font-bold ml-48 mt-8 mb-4">Forgot Password?</Link>
         <button className="bg-black text-white w-24 h-12 rounded-md">Sign In</button>
           </form>
        
        <div className="flex flex-row ml-40 -mt-10">
          <a href="http://" className=""><FacebookIcon className="fill-current text-black w-10 h-10 mr-12"/></a>
          <a href="http://" className=""><InstaIcon className="fill-current text-black w-10 h-10 mr-12"/></a>
          <a href="http://" className=""><TwitterIcon className="fill-current text-black w-10 h-10 mr-12"/></a>
        </div>
       </div>
            </div>
        );
