...
return(
    ...
    <p className="Font-Bold w-full max-h-111 overflow-hidden text-xl font-bold mt-2">{props.text}</p>
    <p className=" w-44 max-h-16 overflow-hidden text-gray-500 text-sm mt-2">This book is about the fundamentals officia aut!  </p>
    </Link>
    </div>
