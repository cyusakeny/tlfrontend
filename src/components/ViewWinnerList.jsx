...
<p className="text-4xl ml-44">Unreal</p>
<p className="text-xl text-gray-color-250 ml-44 ">Unreal@gmail.com</p>
<img src={ProfileImage} alt="ProfilePic" className="h-16 w-16 rounded-full -mt-16" />
...
<div className=" flex flex-row space-x-24 ml-44">
    <p className="text-gray-color-250">Rank:</p>
    <p className="">1</p>
</div>                 
</div>
);
